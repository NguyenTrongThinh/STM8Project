 ...
 626                     ; 164   uint8_t value = 0;
 628                     ; 167   value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
 630  0001 c650a1        	ld	a,20641
 631  0004 a404          	and	a,#4
 633                     ; 169   return((EXTI_TLISensitivity_TypeDef)value);
 637  0006 5b01          	addw	sp,#1
 638  0008 81            	ret	
 651                     	xdef	_EXTI_GetTLISensitivity
 652                     	xdef	_EXTI_GetExtIntSensitivity
 653                     	xdef	_EXTI_SetTLISensitivity
 654                     	xdef	_EXTI_SetExtIntSensitivity
 655                     	xdef	_EXTI_DeInit
 656                     	xref	_assert_failed
 657                     .const:	section	.text
 658  0000               L111:
 659  0000 2e2e5c2e2e5c  	dc.b	"..\..\..\..\librar"
 660  0012 6965735c7374  	dc.b	"ies\stm8s_stdperip"
 661  0024 685f64726976  	dc.b	"h_driver\src\stm8s"
 662  0036 5f657874692e  	dc.b	"_exti.c",0
 682                     	end
